...
아래 모든 작업은 브라우저에서 수행할 수 있습니다. 설치가 필요 없습니다.

---

## 빠른 시작 — 무엇을 하고 싶나요?

> **White Coin (WC)** 은 체인의 기본 통화로, 검증자 노드를 운영하여 획득합니다. **Blue Coin** 은 어떤 조직이든 발행할 수 있는 토큰으로, 내장 AMM에서 거래됩니다.

### "지갑을 만들고 싶어요"

1. [http://8.217.52.231](http://8.217.52.231) 접속 → **Wallet** 클릭
2. 비밀번호 설정 → **Create Wallet** 클릭
3. **12개의 니모닉 문구를 적어두세요** (이것이 백업입니다!)
4. "I have saved my mnemonic" 체크 → keystore 파일 다운로드
5. 완료. 주소가 화면에 표시됩니다

### "White Coin을 받고 싶어요"

1. [http://8.217.52.231](http://8.217.52.231) 접속 → **Faucet** 클릭
2. 주소 붙여넣기 → **Claim** 클릭
3. 100 WC를 받을 수 있습니다 (주소당 24시간에 1회)

### "토큰을 보내고 싶어요"

1. **Wallet**에 들어가기 → keystore 파일 + 비밀번호로 잠금 해제
2. **Transfer WC** 탭 선택 → 받는 주소와 금액 입력 → **Send**

### "나만의 Blue Coin을 발행하고 싶어요"

1. **Wallet**에 들어가기 → 잠금 해제
2. **Deploy** 탭 선택
3. 입력: 이름, 심볼, 풀 비율, 팀 비율, 초기 WC, 월별 해제량
4. **Deploy** 클릭 → 토큰과 AMM 풀이 즉시 생성됩니다

### "Blue Coin을 거래하고 싶어요"

1. **Wallet**에 들어가기 → 잠금 해제
2. **Swap** 탭 선택
3. 토큰 선택, 방향 선택 (WC→Blue 또는 Blue→WC), 금액 입력 → **Swap**

### "검증자를 운영하고 WC를 벌고 싶어요"
...
노드가 자동으로 지갑을 생성하고, 테스트넷에 연결하고, 24시간 후보 기간을 시작합니다. 검증 후 블록당 (15초마다) 50 WC를 획득합니다.

### "체인 데이터를 보고 싶을 뿐이에요"

[http://8.217.52.231](http://8.217.52.231) 접속 — 블록, 트랜잭션, 검증자, Blue Coin, 모든 주소를 탐색할 수 있습니다.
